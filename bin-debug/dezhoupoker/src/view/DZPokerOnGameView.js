...
var DZPokerOnGameView = (function (_super) {
    ...
    DZPokerOnGameView.prototype.ShowOperateBtns = function () {
        if (!this.gp_operation_btns.visible)
            this.gp_operation_btns.visible = true;
    ...
    DZPokerOnGameView.prototype.OnStageClick = function () {
        console.log("点击舞台");
    };
    /**用户操作 */
    ...
    /**退出游戏 */
    DZPokerOnGameView.prototype.QuitTable = function (chairID) {
    };
    /**根据玩家椅子号获得玩家对象 */
    ...
    DZPokerOnGameView.prototype.MainUserBet = function () {
